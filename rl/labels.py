...
def destination_labels(steps, seat, T=719):
    """Returns dest [T, U] int8 (tile index y*10+x, -1 absent), dop [T, U] int8 (op class at destination), dqty [T,U] int8."""
    ...
    for t in range(T):
        ...
        for i, pos in enumerate(units):
            ...
            if found is None:  # only moves/passes until day end: target = current tile, PASS
