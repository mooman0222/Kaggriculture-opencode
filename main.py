"""Kaggriculture agent — E019: HarvestForge-X (8C/4S コア) の採用.
...
検証 (2026-08-31, ローカル):
  - vs base $153.6k (8シード平均、旧 E018 は $103.4k)
  - vs 旧 main.py (E018) H2H 8勝0敗 ($109.4k vs $63.6k)
  - mirror は margin ±$1k 以内 or 完全同点 (クローン戦は僅差勝負)
