"""E064: E063 with clone-gated sell lead 12 turns (was 6). E063: E062 on the v43 chassis (shed-overflow recovery). E062: E061 + SELL-first market slot ordering (stable). Optional endgame sell-phase deferral (LA_PHASE_D0, off by default: tested −0.7k).
...
P = {"shed_hi": int(os.environ.get("LA_SHED", "80")), "lead": int(os.environ.get("LA_LEAD", "12"))}
