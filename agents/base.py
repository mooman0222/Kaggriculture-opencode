"""Kaggle "Kaggriculture: Getting Started" ノートブックの melon_maxxer 原版。

参考: https://www.kaggle.com/code/bovard/kaggriculture-getting-started
改良版 (main.py) との比較ベースラインとして使用する。
"""
