"""E065: E063 + adaptive sell lead: 6 turns by default, doubled once the rival is seen selling a product ahead of our tape schedule (clone games only). E063: E062 on the v43 chassis (shed-overflow recovery). E062: E061 + SELL-first market slot ordering (stable). Optional endgame sell-phase deferral (LA_PHASE_D0, off by default: tested −0.7k).
