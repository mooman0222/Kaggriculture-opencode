...
| パス | 何か | 状態 |
|---|---|---|
| `e081/` (+`e081.tar.gz`) | **提出待ち (09-21 00:00 UTC以降)**。v51-lean-flock 土台 + ライブ層。素v51は素v50に+568/+591、E081はE072に30W2L +491・席差し替えW45→61 | 提出予定 |
| `e079/` (+`e079.tar.gz`) | hcounter + buy-mirror 層 (ref 56382055、LB 2401.3)。パネルDude反転もlive価格フィードバックで相殺 | 現役 |
| `e076/` (+`e076.tar.gz`) | **現行提出**。haideptry Countering-Big3 素のまま (V39+v9 層、ref 56377779) | 現役 |
| `e072/` (+`e072.tar.gz`) | v50-live 土台 + ライブ層。再提出で復帰 (多様性枠) | 枠落ちの可能性 |
| `e080/` | E072 + buy-mirror の実験。v50テープに夜間top-upがなく発火0で**棄却** | 実験残骸 |
