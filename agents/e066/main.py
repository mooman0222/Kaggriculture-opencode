"""E066: E065 のオーバーレイを v46 シャシー (first-turn microstructure + sale timing) に載せ替え。E065 は v43 土台で、素の v45/v46 に負けていた (1W15L / 5W11L)。
...
class Live:
    def __init__(self, folder):
        self.b = _load(folder / "base.py", "e066_base")
        self.reset()
