"""E063: E062 on the v43 chassis (shed-overflow recovery). E062: E061 + SELL-first market slot ordering (stable). Optional endgame sell-phase deferral (LA_PHASE_D0, off by default: tested −0.7k).
