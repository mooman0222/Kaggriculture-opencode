"""E058: ahmedberatozer v41 chassis (0909 tapes + reactive layers) with tapes swapped for
actions.json (GA-evolved) and MMN0222 live extras on top: cash guard for upcoming tape
purchases, clone-gated 6-turn sell lead, shed-pressure relief, opponent-harvest front-run
(OHFR), idle-hand FERTILIZE/WATER/CARE. Additive-only on the market side.
"""
...
class Live:
    def __init__(self, folder):
        self.b = _load(folder / "base.py", "e058_base")
        self.reset()
