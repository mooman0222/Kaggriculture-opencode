...
# --- E058 (MMN0222): tapes come from actions.json next to this file (GA-evolved), not the embedded payload ---
def _e058_tapes():
    import json as _j, os as _o
    _p=_o.path.join(_o.path.dirname(_o.path.abspath(_e058_tapes.__code__.co_filename)),"actions.json")
    return {i:t for i,t in enumerate(_j.load(open(_p)))}
_ROUTES=_e058_tapes()
...
def _router(observation,step,state):
    if step>=144 and not state.get('day6'):
        ...
        state['route']={('BAKERY', 'BAKERY'): 1, ('BAKERY', 'BRUNCH_SPOT'): 3, ('BAKERY', 'FARMERS_MARKET'): 4, ('BAKERY', 'ICE_CREAM_SHOP'): 5, ('BAKERY', 'PET_CAFE'): 6, ('BAKERY', 'PIZZA_SHOP'): 7, ('BAKERY', 'SMOOTHIE_SHOP'): 8, ('BAKERY', 'YARN_STORE'): 9, ('BRUNCH_SPOT', 'BAKERY'): 5, ('BRUNCH_SPOT', 'BRUNCH_SPOT'): 3, ('BRUNCH_SPOT', 'FARMERS_MARKET'): 10, ('BRUNCH_SPOT', 'ICE_CREAM_SHOP'): 5, ('BRUNCH_SPOT', 'PET_CAFE'): 1, ('BRUNCH_SPOT', 'PIZZA_SHOP'): 7, ('BRUNCH_SPOT', 'SMOOTHIE_SHOP'): 5, ('BRUNCH_SPOT', 'YARN_STORE'): 9, ('FARMERS_MARKET', 'BAKERY'): 11, ('FARMERS_MARKET', 'BRUNCH_SPOT'): 12, ('FARMERS_MARKET', 'FARMERS_MARKET'): 4, ('FARMERS_MARKET', 'ICE_CREAM_SHOP'): 7, ('FARMERS_MARKET', 'PET_CAFE'): 13, ('FARMERS_MARKET', 'PIZZA_SHOP'): 5, ('FARMERS_MARKET', 'SMOOTHIE_SHOP'): 5, ('FARMERS_MARKET', 'YARN_STORE'): 14, ('ICE_CREAM_SHOP', 'BAKERY'): 5, ('ICE_CREAM_SHOP', 'BRUNCH_SPOT'): 5, ('ICE_CREAM_SHOP', 'FARMERS_MARKET'): 5, ('ICE_CREAM_SHOP', 'ICE_CREAM_SHOP'): 5, ('ICE_CREAM_SHOP', 'PET_CAFE'): 5, ('ICE_CREAM_SHOP', 'PIZZA_SHOP'): 8, ('ICE_CREAM_SHOP', 'SMOOTHIE_SHOP'): 5, ('ICE_CREAM_SHOP', 'YARN_STORE'): 15, ('PET_CAFE', 'BAKERY'): 3, ('PET_CAFE', 'BRUNCH_SPOT'): 16, ('PET_CAFE', 'FARMERS_MARKET'): 17, ('PET_CAFE', 'ICE_CREAM_SHOP'): 5, ('PET_CAFE', 'PET_CAFE'): 18, ('PET_CAFE', 'PIZZA_SHOP'): 7, ('PET_CAFE', 'SMOOTHIE_SHOP'): 5, ('PET_CAFE', 'YARN_STORE'): 19, ('PIZZA_SHOP', 'BAKERY'): 20, ('PIZZA_SHOP', 'BRUNCH_SPOT'): 5, ('PIZZA_SHOP', 'FARMERS_MARKET'): 21, ('PIZZA_SHOP', 'ICE_CREAM_SHOP'): 22, ('PIZZA_SHOP', 'PET_CAFE'): 5, ('PIZZA_SHOP', 'PIZZA_SHOP'): 23, ('PIZZA_SHOP', 'SMOOTHIE_SHOP'): 24, ('PIZZA_SHOP', 'YARN_STORE'): 25, ('SMOOTHIE_SHOP', 'BAKERY'): 5, ('SMOOTHIE_SHOP', 'BRUNCH_SPOT'): 21, ('SMOOTHIE_SHOP', 'FARMERS_MARKET'): 5, ('SMOOTHIE_SHOP', 'ICE_CREAM_SHOP'): 5, ('SMOOTHIE_SHOP', 'PET_CAFE'): 5, ('SMOOTHIE_SHOP', 'PIZZA_SHOP'): 5, ('SMOOTHIE_SHOP', 'SMOOTHIE_SHOP'): 7, ('SMOOTHIE_SHOP', 'YARN_STORE'): 26, ('YARN_STORE', 'BAKERY'): 19, ('YARN_STORE', 'BRUNCH_SPOT'): 26, ('YARN_STORE', 'FARMERS_MARKET'): 27, ('YARN_STORE', 'ICE_CREAM_SHOP'): 26, ('YARN_STORE', 'PET_CAFE'): 26, ('YARN_STORE', 'PIZZA_SHOP'): 28, ('YARN_STORE', 'SMOOTHIE_SHOP'): 26, ('YARN_STORE', 'YARN_STORE'): 25}.get(tuple(shops[:2]),0)
        state['day6']=True
