...
| 学習方策 (Transformer) | 作り直し中 | 09-24 根本診断: **失敗の原因は行動表現** (v41 の正解ラベルを通すだけで −132k)。engine の行動空間 `rl/raw.py` で BC を再走中 (v41 複製 / 教師 E079)。09-22 の別セッションの記録は HANDOFF.md | `tracks/transformer.md` 0 節 + `rl/README.md` |
