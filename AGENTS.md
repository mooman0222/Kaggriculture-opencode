...
| 学習方策 (Transformer/Policy3) | **凍結 (09-19)** | PPO は critic を 3 水準変えても崩壊 (33k)。BC 単体は 94k で提出系との差 20k のまま | `tracks/transformer.md` + `rl/README.md` |
...
※ 学習方策 (PPO) は 09-19 に凍結。BC のデータ増量だけが残る学習系の手 (`tracks/transformer.md` 9 節)。
