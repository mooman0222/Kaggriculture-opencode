...
### E021〜E027 (2026-09-01): v56 世代への移行とエッジの完成 (詳細は experiments.md)
...
- スロット (2026-09-01 06:52): **orak16 (55934144, 収束中) + orak12 (55930089, 2219+)**

### 次のステップ

1. **orak16 の収束確認** (提出 2026-09-01 06:52 から4-5時間後に ~60試合)。
   orak12 (2219+) を超えるかが判定点。実戦リプレイは fetch_battles.py で取得
...
3. **新敗因クラスの監視**: 2400+ 帯で新しい相手クラスが出たら E021 と同じ手法で分解
